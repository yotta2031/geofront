<template>
  <el-card shadow="hover">
    ...
    <el-table :data="list" v-loading="loading">
      ...
      <el-table-column prop="accountName" label="大V" width="140" />
...
import { getZimediaRecords } from '@/api/zimedia'
...
const status = ref('')
const platform = ref('')
const platforms = [...WEIXIN_PLATFORMS, 'B站']
...
async function fetchList() {
  loading.value = true
  try {
    const res = await getZimediaRecords({
      page: page.value,
      pageSize: 20,
